package com.aarnaSolutions.bdd.utils;
...
public class KenanDatabaseTester {
	...
	public IDatabaseConnection getConnection() throws ClassNotFoundException, SQLException, DatabaseUnitException {
	    Class.forName("com.mysql.jdbc.Driver");
	    java.sql.Connection jdbcConnection = DriverManager.getConnection("jdbc:mysql://localhost:3306/epcis?autoReconnect=true", "epcis", "epcis");
